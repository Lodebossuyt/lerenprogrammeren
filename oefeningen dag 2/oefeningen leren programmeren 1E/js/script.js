...
if((lopendJaar - geboorteJaar) < 0){

    geboortejaar = parseInt(prompt("geboortejaar kan niet hoger zijn dan het lopende jaar, geef uw gevoortejaar opnieuw in"));

}else if((lopendJaar - geboorteJaar) >= 18){
...
/*
1) git add .
2) git commit -m "nieuwe wijziging"
3) git push
